...
//          .then(data => {
//                data.forEach(elements => {
//                  const { market, strategy, marketTrend, timeFrame, startingDate, durationWD} = elements;
...
const results = async () => {
   ...
   .then(data => {
    ...
    const calculateResults = async (data) =>{
     ...
     console.log( symbol , market, strategy, marketTrend, timeFrame, durationWD, statusTrade,
